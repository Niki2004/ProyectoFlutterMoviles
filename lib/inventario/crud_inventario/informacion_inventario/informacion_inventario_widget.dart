...
class InformacionInventarioWidget extends StatefulWidget {
  ...
  @override
  State<InformacionInventarioWidget> createState() =>
      _InformacionInventarioWidgetState();
}

class _InformacionInventarioWidgetState
    extends State<InformacionInventarioWidget> {
  late InformacionInventarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InformacionInventarioModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget.cantidad < 10) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return AlertDialog(
              title: Text('Stock Bajo'),
              content: Text('El producto tiene el stock bajo'),
              actions: [
                TextButton(
      ...
      if (widget.vencimiento!.secondsSinceEpoch <
          getCurrentTimestamp.secondsSinceEpoch) {
        await showDialog(
          context: context,
          builder: (alertDialogContext) {
            return AlertDialog(
              title: Text('Vencimiento Pasado'),
              content: Text('El producto ya esta Vencido'),
              actions: [
                TextButton(
                  onPressed: () => Navigator.pop(alertDialogContext),
                  child: Text('Listo'),
