...
import 'crear_inventario01_model.dart';
export 'crear_inventario01_model.dart';

class CrearInventario01Widget extends StatefulWidget {
  const CrearInventario01Widget({super.key});

  static String routeName = 'Crear_Inventario01';
  static String routePath = '/crearInventario01';

  @override
  State<CrearInventario01Widget> createState() =>
      _CrearInventario01WidgetState();
}

class _CrearInventario01WidgetState extends State<CrearInventario01Widget> {
  late CrearInventario01Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearInventario01Model());
                              ...
                              children: [
                                Expanded(
                                  child: Container(
                                    child: TextFormField(
                                      controller:
                                          _model.txtCantidadTextController,
