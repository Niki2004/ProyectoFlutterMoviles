                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ClipRRect(
                                      ...
                                      child: Image.network(
                                        listViewInventarioRecord.imagen,
                                        width: 120.0,
                                        height: 120.0,
                                        fit: BoxFit.cover,
                                      ),
                                          ...
                                          context.pushNamed(
                                            ...
                                            queryParameters: {
                                              ...
                                              'precio': serializeParam(
                                                listViewInventarioRecord.precio,
                                                ParamType.double,
                                              ),
                                              'vencimiento': serializeParam(
                                                listViewInventarioRecord
                                                    .fechaCaducidad,
                                                ParamType.DateTime,
                                              ),
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        ...
                                        if (confirmDialogResponse) {
                                          ...
                                          context.pushNamed(
                                            VistaInventarioWidget.routeName,
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          context.pushNamed(
                                            ModificarInventarioWidget.routeName,
                                            queryParameters: {
                                              'nombre': serializeParam(
                                                listViewInventarioRecord
                                                    .nombreArticulo,
                                              ...
                                              'marca': serializeParam(
                                                listViewInventarioRecord.marca,
                                                ParamType.String,
                                              ),
                                              'cantidad': serializeParam(
                                                listViewInventarioRecord
