...
import 'vista_historial_empleado_model.dart';
export 'vista_historial_empleado_model.dart';

class VistaHistorialEmpleadoWidget extends StatefulWidget {
  const VistaHistorialEmpleadoWidget({super.key});

  static String routeName = 'VistaHistorialEmpleado';
  static String routePath = '/vistaHistorialEmpleado';

  @override
  State<VistaHistorialEmpleadoWidget> createState() =>
      _VistaHistorialEmpleadoWidgetState();
}

class _VistaHistorialEmpleadoWidgetState
    extends State<VistaHistorialEmpleadoWidget> {
  late VistaHistorialEmpleadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VistaHistorialEmpleadoModel());
  }
