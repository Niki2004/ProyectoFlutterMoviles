...
import 'modificar_empleado_model.dart';
export 'modificar_empleado_model.dart';

class ModificarEmpleadoWidget extends StatefulWidget {
  const ModificarEmpleadoWidget({
    super.key,
    String? nombre,
    String? apellidos,
    required this.edad,
  ...
  final String imagen;
  final bool? estado;
  final DocumentReference? empleadosparaemtro;

  static String routeName = 'Modificar_Empleado';
  static String routePath = '/modificarEmpleado';

  @override
  State<ModificarEmpleadoWidget> createState() =>
      _ModificarEmpleadoWidgetState();
}

class _ModificarEmpleadoWidgetState extends State<ModificarEmpleadoWidget> {
  late ModificarEmpleadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModificarEmpleadoModel());
    ...
    _model.dateOfBirthFocusNode4!.addListener(() => safeSetState(() {}));
    _model.dateOfBirthTextController5 ??= TextEditingController();
    _model.dateOfBirthFocusNode5 ??= FocusNode();
    _model.dateOfBirthFocusNode5!.addListener(() => safeSetState(() {}));
    _model.dateOfBirthTextController6 ??= TextEditingController();
    _model.dateOfBirthFocusNode6 ??= FocusNode();
    _model.dateOfBirthFocusNode6!.addListener(() => safeSetState(() {}));
    _model.switchValue = _model.isDataUploading;
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<EmpleadoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<EmpleadoRecord> modificarEmpleadoEmpleadoRecordList =
            snapshot.data!;
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        controller:
                                            _model.dateOfBirthTextController5,
                                        focusNode: _model.dateOfBirthFocusNode5,
                                        autofocus: true,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        obscureText: false,
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .dateOfBirthTextController5Validator
                                            .asValidator(context),
                                      ),
                                      TextFormField(
                                        controller:
                                            _model.dateOfBirthTextController6,
                                        focusNode: _model.dateOfBirthFocusNode6,
                                        autofocus: true,
                                        textCapitalization:
                                            TextCapitalization.words,
                                        obscureText: false,
                                        ...
                                        cursorColor:
                                            FlutterFlowTheme.of(context)
                                                .primary,
                                        validator: _model
                                            .dateOfBirthTextController6Validator
                                            .asValidator(context),
                                        inputFormatters: [
                                          _model.dateOfBirthMask6
                                        ],
                                      ),
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    await widget.empleadosparaemtro!
                                        .update(createEmpleadoRecordData(
                                      nombre:
                                          _model.fullNameTextController.text,
                                      apellido: _model.ageTextController1.text,
                                      edad: int.tryParse(
                                          _model.ageTextController2.text),
                                      correo: _model
                                          .dateOfBirthTextController2.text,
                                      foto: _model.uploadedFileUrl,
                                      departamento: _model
                                          .dateOfBirthTextController3.text,
                                      jornada: _model
                                          .dateOfBirthTextController4.text,
                                      comentariosAdicionales: _model
                                          .dateOfBirthTextController5.text,
                                      fechaRegistro: _model
                                          .dateOfBirthTextController6.text,
                                    ...
                                    context.pushNamed(
                                        BuscarEmpleadosWidget.routeName);
                                  },
                                  text: 'Actualizar',
