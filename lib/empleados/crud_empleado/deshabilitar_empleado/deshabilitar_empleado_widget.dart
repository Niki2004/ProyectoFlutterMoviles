...
import 'deshabilitar_empleado_model.dart';
export 'deshabilitar_empleado_model.dart';

class DeshabilitarEmpleadoWidget extends StatefulWidget {
  const DeshabilitarEmpleadoWidget({super.key});

  static String routeName = 'Deshabilitar_Empleado';
  static String routePath = '/deshabilitarEmpleado';

  @override
  State<DeshabilitarEmpleadoWidget> createState() =>
      _DeshabilitarEmpleadoWidgetState();
}

class _DeshabilitarEmpleadoWidgetState
    extends State<DeshabilitarEmpleadoWidget> {
  late DeshabilitarEmpleadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeshabilitarEmpleadoModel());
  }
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            context.pushNamed(
                                              EliminarEmpleadoWidget.routeName,
                                              queryParameters: {
