...
import 'crear_evaluacion_empleado_model.dart';
export 'crear_evaluacion_empleado_model.dart';

class CrearEvaluacionEmpleadoWidget extends StatefulWidget {
  const CrearEvaluacionEmpleadoWidget({super.key});

  static String routeName = 'Crear_Evaluacion_Empleado';
  static String routePath = '/crearEvaluacionEmpleado';

  @override
  State<CrearEvaluacionEmpleadoWidget> createState() =>
      _CrearEvaluacionEmpleadoWidgetState();
}

class _CrearEvaluacionEmpleadoWidgetState
    extends State<CrearEvaluacionEmpleadoWidget> {
  late CrearEvaluacionEmpleadoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearEvaluacionEmpleadoModel());
  }
