...
class _AsignarpermisosWidgetState extends State<AsignarpermisosWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().searchMedicos = false;
      safeSetState(() {});
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<MedicoRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<MedicoRecord> asignarpermisosMedicoRecordList = snapshot.data!;
                            ...
                            child: Column(
                              ...
                              children: [
                                          ...
                                          () async {
                                            safeSetState(() {
                                              _model.simpleSearchResults =
                                                  TextSearch(
                                                asignarpermisosMedicoRecordList
                                                    .map(
                                ...
                                Container(
                                  ...
                                  child: Visibility(
                                    visible: FFAppState().searchMedicos,
                                    child: Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          16.0, 16.0, 16.0, 16.0),
                                      child: Builder(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  valueOrDefault<String>(
                                    widget.mediGeneralParametro?.toString(),
                                    'Sin selección de Médico',
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                        ...
                        child: Row(
                          ...
                          children: [
                            FFButtonWidget(
                              onPressed: () async {
                                context
                                    .pushNamed(ClaseExpedienteWidget.routeName);
                              },
                              text: 'Cancelar',
                              icon: Icon(
                                Icons.close,
