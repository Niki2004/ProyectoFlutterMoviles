...
class RespaldoWidget extends StatefulWidget {
  ...
  @override
  State<RespaldoWidget> createState() => _RespaldoWidgetState();
}

class _RespaldoWidgetState extends State<RespaldoWidget> {
  late RespaldoModel _model;
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Configure los respaldos automáticos para proteger la información de los expedientes contra posibles fallas del sistema.',
                            style: FlutterFlowTheme.of(context)
                                .bodyMedium
                                .override(
                                  fontFamily: 'Inter',
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Switch(
                                ...
                                activeColor: Color(0xFF0B7B82),
                                activeTrackColor:
                                    FlutterFlowTheme.of(context).secondaryText,
                                inactiveTrackColor:
                                    FlutterFlowTheme.of(context).secondaryText,
                                inactiveThumbColor: Color(0xFF95A1AC),
                              ),
                            ],
                          ),
                          Row(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              Text(
                                'Notificar al completar respaldo',
                                style: FlutterFlowTheme.of(context)
                                    .bodyLarge
                                    .override(
                                      fontFamily: 'Inter',
