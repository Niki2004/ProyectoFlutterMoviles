...
import 'crear_nota_medico_model.dart';
export 'crear_nota_medico_model.dart';

class CrearNotaMedicoWidget extends StatefulWidget {
  const CrearNotaMedicoWidget({super.key});

  static String routeName = 'Crear_NotaMedico';
  static String routePath = '/crearNotaMedico';

  @override
  State<CrearNotaMedicoWidget> createState() => _CrearNotaMedicoWidgetState();
}

class _CrearNotaMedicoWidgetState extends State<CrearNotaMedicoWidget> {
  late CrearNotaMedicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearNotaMedicoModel());
                                ...
                                onPressed: () async {
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        title: Text('Creación de notas'),
                                        content: Text('Se creo su cita'),
                                        actions: [
                                          TextButton(
