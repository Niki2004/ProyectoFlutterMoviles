...
import 'cancelacion_cita_model.dart';
export 'cancelacion_cita_model.dart';

class CancelacionCitaWidget extends StatefulWidget {
  const CancelacionCitaWidget({super.key});

  static String routeName = 'Cancelacion_Cita';
  static String routePath = '/cancelacionCita';

  @override
  State<CancelacionCitaWidget> createState() => _CancelacionCitaWidgetState();
}

class _CancelacionCitaWidgetState extends State<CancelacionCitaWidget> {
  late CancelacionCitaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CancelacionCitaModel());
                  ...
                  Stack(
                    children: [
                      FlutterFlowIconButton(
                        ...
                        onPressed: () async {
                          context.pushNamed(VistaCancelarWidget.routeName);
                        },
                      ),
                    ],
                  ),
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.all(24.0),
                          child: Text(
                            'Puedes confiar con nosotros para hacer una cita, facíl y rápido',
                            style: FlutterFlowTheme.of(context)
                                .labelMedium
                                .override(
                                  fontFamily: 'Inter',
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Escriba el nombre del médico',
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: 'Seleccione la hora de la cita',
                              hintStyle: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'Inter',
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            cursorColor: FlutterFlowTheme.of(context).primary,
                            validator: _model
                                .emailAddressTextController5Validator
                                .asValidator(context),
                          ),
                        ),
                      ),
